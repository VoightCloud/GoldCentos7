...
//                                        BASE_AMI = getOutput("base_ami")
                                    ...
                                    sh "curl -k -s -X POST https://192.168.137.7:8006/api2/json/nodes/ugli/qemu/109/snapshot/TheSnapshot -H 'Authorization: PVEAPIToken=$PM_API_TOKEN_ID=$PM_API_TOKEN_SECRET'"
